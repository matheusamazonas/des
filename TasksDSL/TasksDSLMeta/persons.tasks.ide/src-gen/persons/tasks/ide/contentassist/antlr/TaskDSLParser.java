		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getTaskAccess().getGroup_12(), "rule__Task__Group_12__0");
					...
					put(grammarAccess.getTaskAccess().getActionAssignment_2(), "rule__Task__ActionAssignment_2");
					put(grammarAccess.getTaskAccess().getPersonsAssignment_4(), "rule__Task__PersonsAssignment_4");
					put(grammarAccess.getTaskAccess().getPrioAssignment_6(), "rule__Task__PrioAssignment_6");
					put(grammarAccess.getTaskAccess().getDurationAssignment_7_1(), "rule__Task__DurationAssignment_7_1");
					put(grammarAccess.getTaskAccess().getProjectsAssignment_9(), "rule__Task__ProjectsAssignment_9");
					put(grammarAccess.getTaskAccess().getUseAssignment_11(), "rule__Task__UseAssignment_11");
					put(grammarAccess.getTaskAccess().getExtendsAssignment_12_1(), "rule__Task__ExtendsAssignment_12_1");
					put(grammarAccess.getProjectAccess().getNameAssignment(), "rule__Project__NameAssignment");
					put(grammarAccess.getProjectUseAccess().getProjectAssignment(), "rule__ProjectUse__ProjectAssignment");
