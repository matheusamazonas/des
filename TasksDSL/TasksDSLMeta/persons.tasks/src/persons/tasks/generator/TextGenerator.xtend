...
class TextGenerator {
	...
	def static dispatch action2Text(PaymentAction action)'''
		«IF action.condition !== null»if «generateExpression(action.condition)» then «ENDIF»Pay «generateExpression(action.amount)» euro'''
	...
	def static dispatch CharSequence generateExpression(ExpressionModulo expr)''' 
		«generateExpression(expr.left)», «generateExpression(expr.right)») >= «generateExpression(expr.left)», «generateExpression(expr.right)») : «generateExpression(expr.left)», «generateExpression(expr.right)») + «generateExpression(expr.right)»)'''
	...
	def static dispatch CharSequence generateExpression(ExpressionBinOp expr) '''
		(«generateExpression(expr.left)» «genBinOp(expr.bop)» «generateExpression(expr.right)»)'''
	...
	def static dispatch CharSequence generateExpression(ExpressionCompOp expr)
		'''(«generateExpression(expr.left)» «genCompOp(expr.op)» «generateExpression(expr.right)»)'''
