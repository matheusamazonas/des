...
public class TaskDSLGrammarAccess extends AbstractGrammarElementFinder {
	...
	public class PlanningElements extends AbstractParserRuleElementFinder {
		...
		//Planning:
		//	'Planning:' name=ID
		//	anonymous?='anonymous'? (persons+=Person | tasks+=Task)*;
		@Override public ParserRule getRule() { return rule; }
		
		//'Planning:' name=ID anonymous?='anonymous'? (persons+=Person | tasks+=Task)*
	...
	public class PaymentActionElements extends AbstractParserRuleElementFinder {
		...
		//('If' condition=BooleanExpression)? 'Pay' amount=IntExpression 'euro'
		public Group getGroup() { return cGroup; }
	...
	public class ExpressionLevel5Elements extends AbstractParserRuleElementFinder {
		...
		//	ExpressionBracket | ExpressionConstantInt | ExpressionBalance;
		@Override public ParserRule getRule() { return rule; }
	...
	public class BalanceElements extends AbstractEnumRuleElementFinder {
