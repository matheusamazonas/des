...
public class GameOfLife extends JFrame implements ActionListener {
	...
	private class GameBoard extends JPanel implements ComponentListener, MouseListener, MouseMotionListener, Runnable {
		...
		public GameBoard() {
			RulesOfLife.computeInitialConfig(point);
		...
		public void run() {
			...
			ArrayList<Point> nextLiveCells = new ArrayList<Point>();
			RulesOfLife.computeSurvivors(gameBoard, nextLiveCells);
			resetBoard();
			point.addAll(nextLiveCells);
			repaint();
			try {
